...
MINIO_PUBLIC_BUCKETS = [config("BUCKET")]

MINIO_POLICY_HOOKS: List[Tuple[str, dict]] = []
MINIO_URL_EXPIRY_HOURS = timedelta(days=1)

MINIO_MEDIA_FILES_BUCKET = config("MINIO_MEDIA_FILES_BUCKET")  # "near"
MEDIA_URL = f"{MINIO_EXTERNAL_ENDPOINT}/{MINIO_MEDIA_FILES_BUCKET}/"
